checkpoint_config = dict(interval=41766)
log_config = dict(
    interval=50,
...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage2_warmup_cam_list_scaled_20250220_205751'
load_from = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage1_bev_pretrain_scaled_hyp_20250129_072148/latest.pth'
resume_from = None
workflow = [('train', 1)]
type = 'Mapper'
plugin = True
...
lr_config = dict(
    ...
    min_lr_ratio=0.95)
evaluation = dict(interval=41766)
find_unused_parameters = True
runner = dict(type='MyRunnerWrapper', max_iters=41766)
SyncBN = True
gpu_ids = range(0, 1)
