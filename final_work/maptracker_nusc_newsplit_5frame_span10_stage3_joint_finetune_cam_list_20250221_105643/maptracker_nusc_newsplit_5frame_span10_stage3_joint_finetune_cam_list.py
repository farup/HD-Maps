checkpoint_config = dict(interval=55688)
log_config = dict(
    interval=50,
...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage3_joint_finetune_cam_list_20250221_105643'
load_from = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage2_warmup_cam_list_20250203_001940/latest.pth'
resume_from = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage3_joint_finetune_cam_list_20250206_102407/latest.pth'
workflow = [('train', 1)]
type = 'Mapper'
plugin = True
plugin_dir = 'plugin/'
...
num_gpus = 1
batch_size = 4
num_iters_per_epoch = 6961
num_epochs = 48
num_epochs_interval = 8
total_iters = 334128
num_queries = 100
...
lr_config = dict(
    ...
    min_lr_ratio=0.003)
evaluation = dict(interval=55688)
find_unused_parameters = True
runner = dict(type='MyRunnerWrapper', max_iters=334128)
profile = False
profile_mem = False
SyncBN = True
gpu_ids = range(0, 1)
