checkpoint_config = dict(interval=20880)
log_config = dict(
    interval=50,
...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage2_warmup_cam_list_scaled_20250218_224235'
...
lr_config = dict(
    ...
    min_lr_ratio=0.95)
evaluation = dict(interval=20880)
find_unused_parameters = True
runner = dict(type='MyRunnerWrapper', max_iters=20880)
SyncBN = True
gpu_ids = range(0, 1)
