checkpoint_config = dict(interval=9282)
log_config = dict(
    interval=50,
...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage1_bev_pretrain_scaled_hyp_4_cam_20250129_071915'
load_from = None
resume_from = None
workflow = [('train', 1)]
type = 'Mapper'
...
img_w = 800
img_size = (480, 800)
cam_list = ['CAM_FRONT', 'CAM_FRONT_RIGHT', 'CAM_FRONT_LEFT', 'CAM_BACK']
num_cams = 4
num_gpus = 1
batch_size = 3
...
lr_config = dict(
    ...
    min_lr_ratio=0.001)
evaluation = dict(interval=9282)
find_unused_parameters = True
runner = dict(type='MyRunnerWrapper', max_iters=55692)
SyncBN = True
gpu_ids = range(0, 1)
