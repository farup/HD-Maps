...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage1_bev_pretrain_scaled_hyp_3_cam_20250129_071646'
load_from = None
resume_from = None
workflow = [('train', 1)]
type = 'Mapper'
...
img_w = 800
img_size = (480, 800)
cam_list = ['CAM_FRONT', 'CAM_FRONT_RIGHT', 'CAM_FRONT_LEFT']
num_cams = 3
num_gpus = 1
batch_size = 3
