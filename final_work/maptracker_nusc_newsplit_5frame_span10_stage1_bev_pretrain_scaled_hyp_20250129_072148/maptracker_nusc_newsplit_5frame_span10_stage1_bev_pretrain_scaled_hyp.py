checkpoint_config = dict(interval=27846)
log_config = dict(
    interval=50,
...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage1_bev_pretrain_scaled_hyp_20250129_072148'
load_from = None
resume_from = '/cluster/home/terjenf/maptracker/final_work/maptracker_nusc_newsplit_5frame_span10_stage1_bev_pretrain_scaled_hyp_20250126_141106/iter_55692.pth'
workflow = [('train', 1)]
type = 'Mapper'
plugin = True
plugin_dir = 'plugin/'
...
num_gpus = 1
batch_size = 3
num_iters_per_epoch = 9282
num_epochs = 18
num_epochs_interval = 3
total_iters = 167076
num_queries = 100
...
model = dict(
    ...
    seg_cfg=dict(
        ...
        canvas_size=(200, 100),
        loss_seg=dict(
            type='MaskFocalLoss', use_sigmoid=True, loss_weight=10.0),
...
match_config = dict(
    ...
    pipeline=[
        ...
        dict(
            ...
            keys=['vectors', 'semantic_mask'],
            meta_keys=[
                'token', 'ego2img', 'ego2cam', 'sample_idx',
                'ego2global_translation', 'ego2global_rotation', 'img_shape',
                'scene_name', 'img_filenames', 'cam_intrinsics',
                'cam_extrinsics', 'lidar2ego_translation', 'lidar2ego_rotation'
            ])
    ],
    interval=1)
data = dict(
...
lr_config = dict(
    ...
    min_lr_ratio=0.001)
evaluation = dict(interval=27846)
find_unused_parameters = True
runner = dict(type='MyRunnerWrapper', max_iters=167076)
SyncBN = True
gpu_ids = range(0, 1)
