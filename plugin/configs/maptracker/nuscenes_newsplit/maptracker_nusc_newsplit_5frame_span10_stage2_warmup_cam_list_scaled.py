...
cam_list = False # (['CAM_FRONT', 'CAM_FRONT_RIGHT', 'CAM_FRONT_LEFT', 'CAM_BACK', 'CAM_BACK_LEFT', 'CAM_BACK_RIGHT'])
...
optimizer = dict(
    type='AdamW',
    lr=6.25e-5, # base learning rate, optim start at. scale down from 5e-4 -> 
    paramwise_cfg=dict(
        custom_keys={
