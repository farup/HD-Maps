...
cam_list = ['CAM_FRONT'] # (['CAM_FRONT', 'CAM_FRONT_RIGHT', 'CAM_FRONT_LEFT', 'CAM_BACK', 'CAM_BACK_LEFT', 'CAM_BACK_RIGHT'])
...
optimizer = dict(
    type='AdamW',
    lr=0.75e-4, # base learning rate, optim start at. scale down from 6e-4 -> 
    paramwise_cfg=dict(
        custom_keys={
            'img_backbone': dict(lr_mult=0.1),
        }),
    weight_decay=0.00125) # from 0.01 to 0.00125
