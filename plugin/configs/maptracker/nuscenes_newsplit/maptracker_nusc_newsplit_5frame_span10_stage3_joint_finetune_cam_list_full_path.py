...
eval_config = dict(
    ...
    ann_file='/cluster/home/terjenf/maptracker/datasets/nuscenes/nuscenes_map_infos_val_newsplit.pkl',
    meta=meta,
    roi_size=roi_size,
    cat2id=cat2id,
    pipeline=[
...
data = dict(
    ...
    train=dict(
        type='NuscDataset',
        data_root='/cluster/home/terjenf/maptracker/datasets/nuscenes',
        ann_file='/cluster/home/terjenf/maptracker/datasets/nuscenes/nuscenes_map_infos_train_newsplit.pkl',
        meta=meta,
        cam_list = cam_list,
        roi_size=roi_size,
        cat2id=cat2id,
...
load_from = "/cluster/home/terjenf/maptracker/ckpts/maptracker_nusc_newsplit_5frame_span10_stage3_joint_finetune/latest.pth"
