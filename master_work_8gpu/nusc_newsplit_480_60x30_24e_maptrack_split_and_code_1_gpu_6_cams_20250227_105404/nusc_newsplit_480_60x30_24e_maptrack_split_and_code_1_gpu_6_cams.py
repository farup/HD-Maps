checkpoint_config = dict(interval=125298)
log_config = dict(
    interval=100,
...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/StreamMapNet/master_work_8gpu/nusc_newsplit_480_60x30_24e_maptrack_split_and_code_1_gpu_6_cams_20250227_105404'
load_from = None
resume_from = '/cluster/home/terjenf/StreamMapNet/master_work_8gpu/nusc_newsplit_480_60x30_24e_maptrack_split_and_code_1_gpu_6_cams_20250224_122754/latest.pth'
workflow = [('train', 1)]
type = 'Mapper'
plugin = True
plugin_dir = 'plugin/'
...
lr_config = dict(
    ...
    min_lr_ratio=0.003)
evaluation = dict(interval=125298)
find_unused_parameters = True
runner = dict(type='IterBasedRunner', max_iters=765710)
SyncBN = True
gpu_ids = range(0, 1)
