checkpoint_config = dict(interval=62640)
log_config = dict(
    interval=100,
...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/StreamMapNet/master_work_8gpu/nusc_newsplit_480_60x30_24e_maptrack_split_and_code_8_gpu_6_cams_20250220_144032'
load_from = None
resume_from = None
workflow = [('train', 1)]
type = 'Mapper'
...
lr_config = dict(
    ...
    min_lr_ratio=0.003)
evaluation = dict(interval=62640)
find_unused_parameters = True
runner = dict(type='IterBasedRunner', max_iters=382800)
SyncBN = True
gpu_ids = range(0, 2)
