...
log_level = 'INFO'
work_dir = '/cluster/home/terjenf/StreamMapNet/master_work_8gpu/nusc_newsplit_480_60x30_24e_maptrack_split_and_code_scaled_1_gpu_6_cams_20250302_165428'
load_from = None
resume_from = None
workflow = [('train', 1)]
type = 'Mapper'
...
runner = dict(type='IterBasedRunner', max_iters=334128)
SyncBN = True
gpu_ids = range(0, 1)
