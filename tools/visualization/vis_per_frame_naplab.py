...
def plot_one_frame_results_with_cams(vectors, id_info, roi_size, scene_dir, image_dict, args):                
...
def vis_pred_data(scene_name, args, pred_results, origin,roi_size, dataset):
    ...
    for index in index_list:
        ...
        cams = dataset.samples[index]['cams']
...
def main():
    ...
    for scene_name in all_scene_names:
        ...
        if args.option == "vis-gt":
            ...
            vis_pred_data(scene_name=scene_name, args=args, pred_results=data, origin=origin, roi_size=roi_size, dataset=dataset)
